                            ...
                            if ($stmt->execute()) {
                                ...
                                if($players->num_rows > 0){
                                    while($player = $players->fetch_assoc()){
                                        ...
                                        if($status == "active"){
                                            echo    "<td> <form action='execute/restrictPlayer.php' method='POST' style='display:inline;'>
                                            ...
                                            echo    "<td> <form action='execute/activatePlayer.php' method='POST' style='display:inline;'>
                                                        <input type='hidden' name='token' value='" . $_SESSION['form_token'] . "'>
                                                        <input type='hidden' name='username' value='$username'>
